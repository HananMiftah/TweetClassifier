...
interface KNNConfigProps {
  ...
  setClassificationMethod: (method: "knn" | "dictionary" | "naiveBayes") => void;
}
...
const KNNConfig = ({
  ...
  const handleAutoLabel = async () => {
    ...
    try {
      const res = await fetch("http://127.0.0.1:8000/api/sentiment/auto-label/", {
        method: "POST",
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value: "knn" | "dictionary" | "naiveBayes") => setClassificationMethod(value)}
            >
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button 
            ...
            disabled={isClassifying || ((classificationMethod === "knn" || classificationMethod === "naiveBayes") && trainingTweets.length === 0) || testTweets.length === 0}
            className="w-full"
            size="lg"
          >
            {isClassifying ? (
